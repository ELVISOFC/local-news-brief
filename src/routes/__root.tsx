...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AreaNews — 5-minute local audio briefing" },
      { name: "description", content: "Wake up knowing exactly what matters around you. A 5-minute AI-summarized daily audio briefing of your local news." },
      { property: "og:title", content: "AreaNews" },
      { property: "og:description", content: "A 5-minute AI-summarized daily audio briefing for your town, county and state." },
